...
class MenuPanel extends React.Component<any, any> {
    ...
    // option 1
    toggleNewDevicePanel() { this.props.dispatch(DisplayActions.ToggleNewDevicePanel()); }
    // option 2
    toggleExImportPanel() {
    ...
    // option 3
    startAllDevices() { this.props.dispatch(DevicesActions.StartAllDevices(this.props.display.deviceSelectedIndex)); }
    // option 4
    stopAllDevices() { this.props.dispatch(DevicesActions.StopAllDevices(this.props.display.deviceSelectedIndex)); }
    // option 5
    reinit() { this.props.dispatch(DevicesActions.loadInitialState(this.props.display.deviceSelectedIndex)); }
    // option 6
    toggleServerPanel() { this.props.dispatch(DisplayActions.ToggleServerPanel()); }
    // option 7
        ...
        return <div className="menu">
            ...
            <div>
                ...
                <button title={this.props.resx.BTN_LBL_EXIMPORT} className={classNames("btn btn-outline-primary menu-btn", this.props.display.showExImportPanel ? "warning-active" : "")} onClick={() => this.toggleExImportPanel()}>
                    <span className="fa fa-lg fa-floppy-o"></span>
                </button>
