...
export const Simulation: React.FunctionComponent<any> = ({ handler }) => {
    ...
    return <div className='simulation'>
        ...
        <div className='simulation-content'>
            <h2>Simulation</h2>
            <p>Adjust the simulation here. Devices must be restarted.</p>
            <div><label>Configuration</label>
                <textarea className='form-control form-control-sm custom-textarea full-width' rows={14} name='simulation' onChange={updateField} value={updatePayload.simulation || ''}></textarea>
            </div>
            <br />
            <div>
